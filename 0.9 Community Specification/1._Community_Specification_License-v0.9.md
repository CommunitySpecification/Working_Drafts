...
**2.2.	Patent Licensing Commitment.**  In addition to rights granted in Section 2.1, Contributor agrees to grant everyone a no charge, royalty-free license on reasonable and non-discriminatory terms to Contributor’s Necessary Claims for:
1) its Implementation of a Draft Specification, where such license applies only to those Necessary Claims infringed by implementing Contributor's Contribution(s) included in that Draft Specification, and
2) its Implementation of the Approved Specification. 
